...
import {getAllCommunityMessages, getAllCommunityMessagesByCommunityId} from "../services/messageServices";
...
export default function CommunityPage() {
  ...
  const getCommunityDescriptionById = (communityId: string) => {
    const community = communities.find((c) => c.id === communityId);
    const communityDescription = community ? community.description : "Unknown Community";
