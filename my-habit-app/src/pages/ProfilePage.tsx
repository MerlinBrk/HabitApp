...
export default function ProfilePage({ onBack }: { onBack: () => void }) {
  ...
  <label htmlFor="profile-image-upload" className="absolute bottom-0 right-0 bg-white rounded-full p-1 shadow cursor-pointer">
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536M9 13l6-6m2 2L9 17H5v-4l6-6z" />
    </svg>
  </label>
  <input
    ...
    accept="image/*"
    className="hidden"
    onChange={()=>{}} // Diese Funktion kannst du später definieren
  />
</div>
