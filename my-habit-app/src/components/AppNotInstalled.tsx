...
const chromeSteps: SafariStep[] = [
    ...
    {
        icon: <MdOutlineAddBox className="w-6 h-6 text-indigo-600" style={{ margin: 'auto' }} />,
        alt: "Zum Startbildschirm hinzufügen",
        text: <>Wähle <b>„Zum Startbildschirm hinzufügen“</b></>,
    },
    {
        icon: <FaPenSquare className="w-5 h-5 text-indigo-600" style={{ margin: 'auto' }} />,
        alt: "Name",
    ...
    },
    {
        icon: <IoPhonePortraitOutline className="w-5 h-5 text-indigo-600" style={{ margin: 'auto' }} />,
        alt: "Home",
        text: <>Die App erscheint auf deinem <b>Startbildschirm</b> und kann wie eine native App genutzt werden.</>,
    },
];

const firefoxSteps: SafariStep[] = [
    {
        icon: <HiOutlineDotsHorizontal className="w-6 h-6 text-indigo-600" />,
        alt: "Menü",
        text: <>Öffne das <b>Menü</b> <span className="text-xs text-gray-400">(drei Punkte in der unteren rechten Ecke)</span></>,
    },
    {
        icon: <MdIosShare className="w-6 h-6 text-indigo-600" style={{ margin: 'auto' }} />,
        alt: "Teilen",
