    ...
    <div className="px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48">
      <div className="relative">
        <input
          ...
          className="w-[400px] text-lg px-2 py-2 rounded-full bg-white/70 backdrop-blur-md shadow-inner border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500"
        />
